...
`dotspacemacs/user-config' first."
  ...
  (mapc 'load (directory-files "~/.spacemacs.d/private_packages/" t "\\.el\\'"))
...
you should place your code here."
  ;; make_header
  (setq make-header-author-name "ChengYi")
  (setq make-header-author-email "chengyi@antiy.cn")
...
(custom-set-faces
 ...
 '(cursor ((t (:background "lawn green" :foreground "#002b36" :inverse-video t)))))
