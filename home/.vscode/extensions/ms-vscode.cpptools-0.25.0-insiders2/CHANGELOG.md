...
* Add support for resolving missing includes via the `vcpkg` dependency manager. [PR [#3791](https://github.com/Microsoft/vscode-cpptools/issues/3791)](https://github.com/microsoft/vscode-cpptools/pull/3791)
